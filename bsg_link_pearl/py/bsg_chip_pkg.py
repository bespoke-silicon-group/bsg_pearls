...
from bsg_chip_pkg_gen import (
    ...
    BsgChipObject,
    BsgChipParamObject,
    BsgChipPackageObject,
    BsgChipTagClientGroupObject,
    BsgChipTagClientObject,
)


class BsgSdrLinkPearlPkg(BsgChipPkg):
    def __init__(self):
        super().__init__(name="bsg_sdr_link_pearl", struct="bsg_chip")
        ...
        self.add(
            ...
            .add(BsgChipTagClientGroupObject("bsg_link_sdr_tag_lines", "sdr")
